...
export default function KBPreview({ markdown, loading, ticket }: Props) {
  ...
  return (
    <section className="rounded-sm border border-line bg-white/60 p-6">
      ...
      <div className="mt-5 min-h-[280px] rounded-sm border border-dashed border-line bg-white p-5">
        {markdown ? (
